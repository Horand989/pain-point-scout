...
SYSTEM = (
    ...
    "HARD RULES:\n"
    "- Write in PLAIN, SIMPLE English. Short sentences. Everyday words. Clear over clever. "
    "A busy person should understand it instantly (about a grade 6 to 8 reading level). "
    "Never be abstract, fancy, or write a sentence someone would have to re-read.\n"
